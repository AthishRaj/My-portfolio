export default function Nav() {
  return (
    <>
      <nav className="bg-gray-950 h-14 flex items-center w-full " >
        <ul className=" flex flex-row justify-between items-center w-full mx-3 h-full" >
          <li>
          ...
          <li className=" h-full" >
            <ul className=" nav-items items-stretch flex h-full" >
              <li>
